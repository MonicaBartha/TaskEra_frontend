...
import { statusTitle } from '@/locales/en';
              ...
              >
                <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                  ...
                  {data.completedBy.length ? (
                    <>
                      <p className='font-bold text-l text-slate-600 my-5'>Update history: </p>
                      <ul className=' list-decimal ml-7'>
                        {data.completedBy.map((activityLog) => (
                          <li key={activityLog._id}>
                            <span className='font-bold text-slate-600'>{statusTitle[activityLog.status]}</span>
                  ...
                  <div className='my-5 space-y-3'>
                    <label className='font-bold'>Actual state:
                    </label>
                    <select
                    ...
                    >
                      {Object.entries(statusTitle).map(([key, value]) => (
