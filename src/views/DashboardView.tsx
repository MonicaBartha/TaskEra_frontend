    ...
    <>
      ...
      {data.length ? (
        <ul role="list" className="divide-y divide-gray-100 mt-10">
          {data.map((project) => (
            <li key={project._id} className="flex justify-between gap-x-6 px-10 py-5 bg-white shadow-lg mb-5">
        ...
        <p className="text-center py-20">There are no created projects yet. {''}
          <Link
            to='/projects/create'
