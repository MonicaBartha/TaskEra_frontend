  ...
  return (
    <>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-2xl font-light text-gray-500 mt-5">Use the form below to create a new project</p>
        ...
        <form className="mt-18 bg-white shadow-lg p-10 rounded-lg"
